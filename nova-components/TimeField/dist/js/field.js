...
Nova.booting(function (Vue, router, store) {
    Vue.component('index-time-field', __webpack_require__(3));
    Vue.component('detail-time-field', __webpack_require__(6));
    Vue.component('form-time-field', __webpack_require__(9));
});
