<template>
    <div class="relative">
        ...
        <div>
        <heading class="mb-6">New Reminder</heading>
                <div class="card">
                        ...
                        <div>
                           ...
                           <!--  <div class="flex border-b border-40">
                                ...
                                <div class="w-full px-8 py-6">
                                    ...
                                    <div v-if="errors['data.content']" :class="['help-text error-text mt-2 text-danger']">
                           ...
                           <!--  <div class="flex border-b border-40">
                                ...
                                <div class="w-1/4 px-8 py-6">
                                    ...
                                    <div v-if="errors['data.status']" :class="['help-text error-text mt-2 text-danger']">
                                        @{{ errors['data.status'][0] }}
                                    </div>
                                </div>
                            </div>
 -->
                        ...
                        <div class="bg-30 flex px-8 py-4">
                            <button type="submit" v-on:click="clickk('new')" v-model="submit_an" class="ml-auto btn btn-default btn-primary mr-1">
                                Create & Another
                            </button>
                            <button type="submit" v-on:click="clickk('submit')" v-model="submit" class="ml btn btn-default btn-primary mr-3">
                                Create Reminder
                            </button>
                        </div>
                    </form>
